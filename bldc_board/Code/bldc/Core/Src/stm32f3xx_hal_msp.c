...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC2_MspInit 0 */
    ...
    PA4     ------> ADC2_IN1
    */
    GPIO_InitStruct.Pin = ADC_DC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC_DC_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA4     ------> ADC2_IN1
    */
    HAL_GPIO_DeInit(ADC_DC_GPIO_Port, ADC_DC_Pin);
...
void HAL_COMP_MspInit(COMP_HandleTypeDef* hcomp)
{
  ...
  /* USER CODE END COMP1_MspInit 0 */
    ...
    PA1     ------> COMP1_INP
    */
    GPIO_InitStruct.Pin = COMP_U_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(COMP_U_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END COMP3_MspInit 0 */
    ...
    PB14     ------> COMP3_INP
    */
    GPIO_InitStruct.Pin = COMP_W_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(COMP_W_GPIO_Port, &GPIO_InitStruct);
...
void HAL_COMP_MspDeInit(COMP_HandleTypeDef* hcomp)
{
  ...
  /* USER CODE END COMP1_MspDeInit 0 */
    ...
    PA1     ------> COMP1_INP
    */
    HAL_GPIO_DeInit(COMP_U_GPIO_Port, COMP_U_Pin);
  ...
  /* USER CODE END COMP3_MspDeInit 0 */
    ...
    PB14     ------> COMP3_INP
    */
    HAL_GPIO_DeInit(COMP_W_GPIO_Port, COMP_W_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = PWM_L3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF6_TIM1;
    HAL_GPIO_Init(PWM_L3_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = PWM_H1_Pin|PWM_H2_Pin|PWM_H3_Pin|PWM_L2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF6_TIM1;
